        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              手語如同你、我在日常生活中使用的語言，<br />
              不論是中文、英文、還是手語，語言不僅是作為溝通的媒介，<br />
              更蘊含文化脈絡、生活態度及豐富的藝術美學。
              <br />
              手語演繹不僅是服務聾人，展現「聾人文化」的重要方式。<br />
              本計畫以「打造聾人友善的音樂環境」為核心，<br />
              致力於讓手語在大眾娛樂文化中被看見、被理解，<br />
              進而推動文化平權，讓不同語言與感知方式都能共融於生活之中。
            </p>
          </div>
        </div>
      </section>
